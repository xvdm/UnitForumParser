...
namespace Services.Migrations
{
    ...
    [Migration("20240620182352_LogCommandOptions")]
    partial class LogCommandOptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Services.Entities.Logs.LogCommandOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("LogCommandId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LogCommandId");

                    b.ToTable("LogCommandOptions");
                });
            ...
            modelBuilder.Entity("Services.Entities.Logs.LogCommandOption", b =>
                {
                    b.HasOne("Services.Entities.Logs.LogCommand", "LogCommand")
                        .WithMany("LogCommandOptions")
                        .HasForeignKey("LogCommandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LogCommand");
                });
            ...
            modelBuilder.Entity("Services.Entities.Logs.LogCommand", b =>
                {
                    b.Navigation("LogCommandOptions");
                });
